...
abstract class AppLocalizations {
  ...
  /// No description provided for @markdownPreviewDescription.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @sortByDateModified.
  ///
  /// In en, this message translates to:
  /// **'Sort by Date Modified'**
  String get sortByDateModified;
  ...
  /// No description provided for @searchApplied.
  ///
  /// In en, this message translates to:
